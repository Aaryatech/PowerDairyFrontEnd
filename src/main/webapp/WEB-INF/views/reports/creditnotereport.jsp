...
<c:url var="getCrenditNoteReport" value="/getCrenditNoteReport" />
							...
							<table id="table_grid" class="main-table">
								<thead>
									<tr class="bgpink">
										...
										<th class="col-md-1"style="text-align:center">Crn No</th>
												...
												function(key,
													...
													tr
															.append($(
																	...
																	.html(
																			creditReport.crnDate));
													tr
															.append($(
																	'<td class="col-md-1"></td>')
																	.html(
																			creditReport.crnHeaderId));

													tr
															.append($(
																	'<td class="col-md-2"style="text-align:left"></td>')
																	.html(
																			creditReport.custName));
													tr
															.append($(
																	'<td class="col-md-2"style="text-align:right"></td>')
																	.html(
																			creditReport.grandTotal));
													tr
															.append($(
																	'<td class="col-md-1"style="text-align:center"></td>')
																	.html(
																			creditReport.expireQty));

													tr
															.append($(
																	'<td class="col-md-1"style="text-align:center"></td>')
																	.html(
																			creditReport.leakageQty));
													tr
															.append($(
																	'<td class="col-md-1"style="text-align:left"></td>')
																	.html(
																			creditReport.remarks));
...
<script type="text/javascript">
	function genPdf() {
		...
		window
				.open('${pageContext.request.contextPath}/genPdfCreditNoteReport/'
						+ fromDate + '/' + toDate);
