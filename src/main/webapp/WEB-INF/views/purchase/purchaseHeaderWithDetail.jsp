				...
				<form name="frm_search" id="frm_search" method="post"
					...
					<input type="hidden" name="mod_ser" id="mod_ser"
						...
						<div class="col-md -3">
								...
								<div class="col1title" align="left"><h3> Purchase Bill Detail</h3></div>
						</div>
							...
							<thead>
								<tr class="bgpink">
												<th class="col-sm-1">Sr no.</th>
													...
													<th class="col-md-1">Leakage No</th> 
							...
							<tbody>
								...
								<c:forEach items="${getPoHeader.poDetailList}" var="poDetailList"
									...
									<tr>
										...
										<td class="col-md-1" ><c:out
												value="${poDetailList.shortNo}" /></td>
										<td class="col-md-1" ><c:out
												value="${poDetailList.extraNo}" /></td>
										<td class="col-md-1" ><c:out
												value="${poDetailList.poLeakageQty}" /></td>
										<td class="col-md-1" ><c:out
